...
export const blessingsData: Blessing[] = [
  ...
  },
  {
    ...
    user: '匿名',
    text: '        西江月—辰欢欢喜就\n辰日欢欢喜就，生旦喜喜欢成。\n来去不知何明暮，归离可叹今处。\n众起群言一律，独我自酌百情。\n伶人盛喜赛明日，宝珍共享福纪！',
    avatarUrl: asset('/avatars/匿名.webp'),
  },
  {
    id: 'wish_014',
    user: 'hhxki',
    text: '祝我们最最可爱的伶宝生日快乐。ok啊也是祝你生日快乐了好吧。忙死我了不知道还能不能录上歌了就先写这些吧拜拜',
    avatarUrl: asset('/avatars/hhxki.webp'),
  },
  {
    id: 'wish_015',
    user: '肚饿真菌',
    text: '哟喂～伶酱生日快乐啊，也是感谢你这许多年的陪伴，无论如何衷心希望你未来能越来越好呀！另，今年尽量给你补上点菌子吃吃',
    avatarUrl: asset('/avatars/肚饿真菌.webp'),
  },
]
//歌单候选 
//世界は私のためだけに—さんうさぎ
